...
func DefaultOperationBindings() []OperationBinding {
	return []OperationBinding{
		...
		{Surface: "system_graphql", Operation: "workspaceMembers", Capability: CapMembersRead},
		{Surface: "system_graphql", Operation: "inviteWorkspaceMember", Capability: CapMembersWrite},
		{Surface: "system_graphql", Operation: "updateWorkspaceMember", Capability: CapMembersWrite},
		{Surface: "system_graphql", Operation: "removeWorkspaceMember", Capability: CapMembersWrite},
		{Surface: "system_graphql", Operation: "teamMembers", Capability: CapMembersRead},
